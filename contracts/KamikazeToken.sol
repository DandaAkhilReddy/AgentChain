...
contract KamikazeToken is IERC20 {
    ...
    constructor() {
        ...
        symbol = "KAMIKAZE";
        decimals = 18;
        _totalSupply = 1000000000 * 10**decimals; // 1 billion tokens
